// src/lib.rs
/*
 * Core library for WalletNotifier
 */
...
#[derive(Debug)]
pub struct WalletNotifierProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WalletNotifierProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WalletNotifier processing");
    
    let mut processor = WalletNotifierProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WalletNotifierProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WalletNotifierProcessor::new(false);
